        ...
        jQuery.ajax({
            ...
            success : function(result){
                ...
                if(message.msg=='valid'){
                    ...
                    jQuery('.login_msg p').html('You are Loggedin...');
                }
                if(message.msg=='wrong'){
                    jQuery('.login_msg p').html('Please enter valid credential');
                }
            }
        });
    }
